...
#[async_std::main]
async fn main() {
    let my_stdout = File::create("/tmp/celestia-stdout.log").expect("Failed to create stdout file");
    let my_stderr = File::create("/tmp/celestia-stderr.log").expect("Failed to create stderr file");
