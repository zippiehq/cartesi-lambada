...
CMD sh -c "ipfs daemon & sleep 10 && /usr/bin/jsonrpc-remote-cartesi-machine --server-address=127.0.0.1:50051 & sleep 10 && RUST_LOG=info /bin/cartesi_lambda /machines/txnotice sequencer_db"